...
$amount_c = 0;
$sqlmi = "SELECT * FROM aos_products,aos_products_cstm where id=id_c and id='".$_GET['id']."'";
$resmi = $conn->query($sqlmi);
$rowmi = $resmi->fetch_assoc(); 

?>
<!DOCTYPE html>
<html lang="en" dir="ltr">
<!-- Mirrored from red-parts.php.themeforest.scompiler.ru/themes/red-ltr/product-full.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 May 2020 20:26:11 GMT -->

<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<meta name="format-detection" content="telephone=no">
<title>Product Full — Maxvision</title>
...
<!-- site__header / end --><!-- site__header / end -->
<!-- site__body -->
...
<!--    aria-current="page"><span class="breadcrumb__item-link">-->
<!--STABLISER LINK ( BOLT ) KIT ASSY.-->
...
<!--</span></li>-->
  ...
  <a href="#" onclick="closeWinNow()" onClick="closeWin">
<img src="backbutton.png"  class="block-header__title"  width="45px" style="
    margin-left: 5%;"></a>
...
<div class="product-gallery__featured">
 <div class="owl-carousel"><a href="http://maxvisionparts.in/admin/upload/<?php echo $rowmi['url']; ?>"
target="_blank">

<img height="120%" width="120%" src="http://maxvisionparts.in/admin/upload/<?php echo $rowmi['url']; ?>"
    alt=""> </a>
             </div>
</div>
...
margin-left: 20%;
">Our Ref No:<?php echo $rowmi["part_number"]; ?></h1>
<div class="product__subtitle">
    <div class="product__rating">
 
    </div>
    <!-- <div style="padding-top: 5%; float: left;"> -->
    <div class="product__meta" style="width: 81%;line-height: 160%;padding-top: 5%;font-size: 200%;margin-left: 10%;">
            <table>
            <tr style="font-size: 140%;">
                     <th colspan="2"><?php echo $rowmi['name'];?></th>
                    
                </tr>
                <tr style="font-size: 120%;">
                    <th >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OEM Code:</th>
                <td ><?php echo $rowmi["description"]; ?></td>
                </tr>
                <tr style="font-size: 120%;">
                    <th >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vehicle:</th>
                     <td ><?php echo $rowmi["vehicle_c"]; ?>&nbsp;&nbsp;&nbsp;</td>
                </tr>
                <tr style="font-size: 120%;">
                    <th >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Model:</th>
                     <td ><a href="#" style="color: black;"><?php echo $rowmi["model_c"]; ?>&nbsp;&nbsp;&nbsp;</a></td>
                </tr>
                <tr style="font-size: 120%;">
                    <th >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PerVhcl:</th>
                      <td ><?php echo $rowmi["per_vehicle_c"]; ?>&nbsp;&nbsp;&nbsp;</td>
                </tr>
                <tr style="font-size: 120%;">
                    <th >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pkg.Unit:</th>
                      <td ><?php echo $rowmi["pkgunit_c"]; ?>&nbsp;&nbsp;&nbsp;</td>
                </tr>
                <tr style="font-size: 120%;">
                    <th >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                    <td >&nbsp;&nbsp;&nbsp;</td>
        ...
        <style>
            .product__meta tr+tr>* {
             border-top: 1px solid #594a4a;}

        </style>
  '
    <div>Note: *All Oemcodes, Vehicle And Model Names Are Strictly Meant For Reference And Compatibility Purpose Only.*
</div>
</div>
...
<div class="product__info" id="typecondition">
<div class="product__info-card">
    <div class="product__info-body">
        <!-- <div class="product__badge tag-badge tag-badge--sale">Sale</div> -->
    <div class="product__prices-stock">
<div class="product__prices">
    <div class="product__price product__price--current">₹ <?php echo number_format((float)$rowmi['price'], 2, '.', '');    ?>
    </div>
</div>
         </div>
       <?php $idc = $rowmi['d_lnc_c']; if($idc == ""){ echo "The Rate Mentioned is <b>B2B</b> <b style='color: red;'>Listprice</b> <br><b>(-)</b> Usual Discount Will Be Offered<br><b>(+)</b> Applicable GST Will Be Charged "; } else { echo "The Rate Mentioned is <b>B2B</b> <b style='color: red;'>Nett Price</b> <br><b>(+)</b> Applicable GST Will Be Charged"; } ?></b>
         
     </div>
 
<div class="product__actions">
<div class="product__actions-item product__actions-item--quantity">
<?php $qry = "SELECT probability from opportunities where description = '".$rid."' and next_step = '".$rowmi["id"]."' and deleted=0";
$unit = '';
$ans = $conn->query($qry);
 if ($ans->num_rows>0){
...
<div class="input-number"><input id="<?php echo $rowmi["id"]; ?>"
        class="input-number__input form-control form-control-lg"
        type="number" min="0" value="<?php echo $unit; ?>" onchange="add(this.id, this.value)">
    <div class="input-number__add"></div>
    <div class="input-number__sub"></div>

</div>
<span id="addtocart<?php echo $rowmi["id"]; ?>" style="font-size: 14px; display: none;" >Updated your cart</span>

</div>
<div class="product__actions-item" style="padding-top: 3%;">
 Unit : <?php echo $rowmi["unit_c"]; ?>
</div>
...
<div class="product__actions-divider"></div>
    ...
    <div class="product__tags-and-share-links" >
        Note: The Rates Mentioned Above Are Subject To Change Without Prior Notice And Rates Applicable At The Time Of Supply Will Be Charged
...
if($type == 'VENDOR')
{
echo "<script> $('#typecondition').hide(); </script>";
}
?>
...
<!-- mobile-menu --> <div class="mobile-menu">
