...
?>
    ...
    <li class="breadcrumb__item breadcrumb__item--parent"><a href="#" style="color: black; position: relative; top: 10px; left:0%; font-size: large;">New Arrival
    </a></li>
    </ol>
    </nav>
    </div>
    ...
    <div class="products-view__list products-list products-list--grid--6" data-layout="grid" data-with-features="true">
              ...
              <div class="products-list__content">
                    ...
                    //   $sqlre = "SELECT * FROM `prospects` where department='".$rowcu['accode_c']."'";
                    ...
                    //                                  $unit = 0;
                          ...
                          $sql = "SELECT * FROM aos_products,aos_products_cstm where id=id_c and deleted = 0 and newarrivals_c = 'Y' order by part_number asc ";
                             $result = $conn->query($sql);
                          while ( $row = $result->fetch_assoc()){
