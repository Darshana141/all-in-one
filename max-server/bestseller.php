...
?>
    ...
    <li class="breadcrumb__item breadcrumb__item--parent"><a href="#" style="color: black; position: relative; top: 10px; left:0%; font-size: large;"> Best Seller
    </a></li>
    </ol>
    </nav>
    </div>
 ...
 $dbname = "partsvis_maxvision";
                     ...
                     $sqlcu = "SELECT * FROM contacts,contacts_cstm where id=id_c and  id = '".$rid."' and deleted = 0 ";
                          ...
                          $sql = "SELECT * FROM aos_products,aos_products_cstm where id=id_c and deleted = 0 and bestseller_c = 'Y' order by part_number asc";
                             $result = $conn->query($sql);
                           while($row = $result->fetch_assoc()){
                                                    $count = $count +1;
