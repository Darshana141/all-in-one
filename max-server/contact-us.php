...
if($user=="")
{
    echo '<div class="newlogodescription">
<a href="logout.php" id="removesession"><span class="indicator__icon"><img src="LOGINGBUTTON.png" style="width: 55px;height: 45px;margin-left: 40px;margin-top: -15px;">
<p class="newlogodescriptionresize1" style="font-size: 12px;margin-left: 50px;">';
echo "LogIn";
} 
else
{  
 echo '<div class="newlogodescription">
<a href="logout.php" id="removesession"><span class="indicator__icon"><img src="newlogout.png" style="width: 55px;height: 45px;margin-left: 40px;margin-top: -15px;">
<p class="newlogodescriptionresize1" style="font-size: 12px;margin-left: 50px;">';
echo "Log-out";
}
?>
...
<div class="newlogodescription">
<a href="account-login.php"><span class="indicator__icon"><img src="newaccouticon.png" style="
width: 50px;
height: 44px;
margin-left: -120px;
margin-top: -13px;
                    ...
                    <div class="block-header__body">
                        <nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
                            <ol class="breadcrumb__list">
                                ...
                                <li class="breadcrumb__title-safe-area" role="presentation" style="--block-header-title-width:113.6px;"></li>
                            </ol>
                        </nav>
                                ...
                                <div class="col-12 col-lg-6 pb-4 pb-lg-0">
                                    <div class="mr-1">
                                        ...
                                        <div class="contact-us__address">
                                            <p>Shop No. 16, 17, & 18, <br>Jagmohan Mansion, 20, Avantikabai Gokhale Street, Opera House,<br>
                                            Mumbai - 400 004 (India)<br>
                                            Email: maxvisionn@gmail.com<br>
                                           <a href="tel:+91 9322894418"> <i class="fa fa-phone"></i>
                                            Phone Number 
                                          </a>
                                        :  <a href="tel: 022-2386 2237"> 022-2386 2237</a>  /  <a href="tel: 3550 5982"> 3550 5982 </a>/  <a href="tel:+91 9322894418">9322894418</a> 
                                        ...
                                        <form>
                                            <div class="form-row">
                                                <div class="form-group col-md-6"><label for="form-name">Your
                                                        Name</label> <input type="text" id="form-name" class="form-control" placeholder="Your Name"></div>
        ...
        <footer class="site__footer">
            <div class="site-footer">
                <div class="site-footer__bottom">
                    <div class="container">
                        <div class="site-footer__bottom-row" style="
    color: white;
">
                            ...
                            <div class="site-footer__payments">
                                    Address:
                                    Shop No. 16, 17, & 18, Jagmohan Mansion, 20, Avantikabai Gokhale Street, Opera House,
...
if($user=="")
{
    echo ' <a href="logout.php" id="removesession" class="mobile-menu__indicator">
    <span class="indicator__icon"><img src="LOGINGBUTTON.png" style="
    height: 50px;
    ">
    </span>
