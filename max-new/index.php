...
$city_name = isset($_SESSION['city_name']) ? $_SESSION['city_name'] : '';
...
$salesmanid = isset($_SESSION['salesman']) ? $_SESSION['salesman'] : '';
...
<div style="position: relative;left: -56px;bottom: 20px;">
    <?php echo $user; if($city_name!="") echo "(".$city_name.")"; ?>
</div>
...
color: white;
"> 
Copyright <a href="https://cureinfotech.com/">©</a> 2020 <a href="https://cureinfotech.com/">maxvisionparts.in</a> All Rights Reserved.
